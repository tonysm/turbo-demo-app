...
Importmap::pin("process", to: "https://ga.jspm.io/npm:@jspm/core@2.0.0-beta.24/nodelibs/browser/process-production.js", preload: true);
Importmap::pin("axios", to: "https://ga.jspm.io/npm:axios@0.27.2/index.js");
Importmap::pin("laravel-echo", to: "https://ga.jspm.io/npm:laravel-echo@1.11.7/dist/echo.js", preload: true);
Importmap::pin("pusher-js", to: "https://ga.jspm.io/npm:pusher-js@7.1.0-beta/dist/web/pusher.js", preload: true);
