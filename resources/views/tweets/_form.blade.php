<div class="flex p-4 space-x-4 bg-white">
    ...
    >
        ...
        <div class="block">
            ...
            <x-textarea name="content" id="" rows="2" placeholder="What's happening?" value="{{ old('content', $tweet->content) }}" />
            @error('content')
            <span class="mt-2 text-sm text-red-600">{{ $message }}</span>
            @enderror
        </div>

        <div class="mt-4 space-y-4 sm:flex sm:justify-between sm:items-center sm:space-y-0">
