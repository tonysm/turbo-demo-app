...
<div class="sticky top-0 z-10 px-1 pt-3 -mx-1 -mt-3 bg-white border-b trix-toolbar" id="{{ $id }}">
    <div class="flex flex-wrap items-center" data-controller="reveal" data-reveal-hide-keys-value="escape,enter">
        ...
        <span class="hidden trix-button-group trix-button-group--history-tools" data-trix-button-group="history-tools">
            <button type="button" class="trix-button--icon trix-button--icon-undo" data-trix-action="undo"
                data-trix-key="z" title="#{lang.undo}" tabindex="-1">#{lang.undo}</button>
            <button type="button" class="trix-button--icon trix-button--icon-redo" data-trix-action="redo"
                data-trix-key="shift+z" title="#{lang.redo}" tabindex="-1">#{lang.redo}</button>
        </span>
