<div class="inline-block m-1" id="{{ dom_id($entry, 'create_reaction_trigger') }}">
    <x-jet-dropdown align="center" width="w-80" contentClasses="py-1 bg-gray-100">
        <x-slot name="trigger">
            <button
                class="items-center justify-between hidden p-2 space-x-1 text-gray-500 transition duration-150 ease-in-out border rounded-full md:inline-flex hover:text-gray-700 focus:outline-none focus:border-gray-300"
            >
