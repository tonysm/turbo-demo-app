...
const echo = new Echo({
    ...
    cluster: document.head.querySelector('meta[name=echo-pusher-app-cluster]').content,
    forceTLS: document.head.querySelector('meta[name=echo-pusher-use-tls]').content === "true",
